...
- **Real-time Data**: RESTful API with automatic data synchronization
...
npm run rtk-codegen       # Generate API types from OpenAPI
```
...
3. **API Generation**: Run `npm run rtk-codegen` in frontend if API types are outdated
